...
// place keyframes at frame bias (within range)
// 
...
function execute()
{
	...
	while (currentFrame < endFrame)
	{
		...
		prop.setValueAtTime(_time, prop.valueAtTime(_time, true));
...
// 	{
// 		var _time = convertFPSToTime(currentFrame, fps);
// 		alert(prop.valueAtTime(_time, true));
// 		frameValues.push(prop.prop.valueAtTime(_time, true));
// 		currentFrame += frameBias;
// 	}
...
// 	{
// 		var _time = convertFPSToTime(currentFrame, fps);
// 		prop.setValueAtTime(_time, prop.valueAtTime(frameValues[kf - 2], true));
// 		currentFrame += frameBias;
// 		//prop.setInterpolationTypeAtKey(kf, KeyframeInterpolationType.HOLD, KeyframeInterpolationType.HOLD);
// 		kf++;
// 	}
